...
#    Aug 17, 2020 08:44:12 PM -03  platform: Linux
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = Toplevel1 (root)
    projetoEmail_supportN.init(root, top)
    root.mainloop()
...
def create_Toplevel1(rt, *args, **kwargs):
    ...
    w = tk.Toplevel (root)
    top = Toplevel1 (w)
    projetoEmail_supportN.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel1:
    ...
    def __init__(self, top=None):
        ...
        top.resizable(1, 1)
        top.title("Mensagens automática")
        ...
        self.textoEmail = tk.Entry(self.Frame1)
        self.textoEmail.place(relx=0.011, rely=0.582, height=247, relwidth=0.472)

        self.textoEmail.configure(background="white")
        self.textoEmail.configure(font="TkFixedFont")
        self.textoEmail.configure(selectbackground="blue")
        self.textoEmail.configure(selectforeground="white")

        self.Label1 = tk.Label(self.Frame1)
        self.Label1.place(relx=0.011, rely=0.551, height=15, width=438)
        self.Label1.configure(activebackground="#f9f9f9")
        self.Label1.configure(text='''Digite aqui a mensagem que será enviada''')
        ...
        self.checkAnexo.configure(variable=projetoEmail_supportN.che59)
